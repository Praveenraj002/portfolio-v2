    ...
    <>
      <div className="w-screen h-screen">
        <div className="relative">
          ...
          <div className="absolute inset-0 flex flex-col gap-3 items-center justify-center z-50 text-center text-white font-poppins container mx-auto px-2">
            <h2 className="text-xl font-semibold">Hello there, this is Praveen Raj.</h2>
            <h1 className="text-2xl font-bold">
              I love Building things that lives on the Internet.
            </h1>
            <p className="font-inter text-base my-6">
    ...
    <>
      <div className="w-screen h-screen">
        <div className="relative">
          ...
          <div className="absolute inset-0 flex flex-col gap-3 items-center justify-center z-50 text-center text-white font-poppins">
            ...
            <p className="font-inter text-xl w-3/5 my-3">
              Passionate about developing software and web applications using a
              variety of cutting-edge tools and technologies with good
              technical, problem-solving, and interpersonal skills.
            </p>
            <div className="flex gap-6 w-full items-center justify-center mt-10">
              <BlueButton>My Resume</BlueButton>
              <WhiteButton>Contact me</WhiteButton>
            </div>
          </div>
