...
const WorkflowCard = (props) => {
  return (
    <>
      <div className="flex flex-col items-start justify-start text-start bg-atlassianLightBlue pt-6 rounded-sm drop-shadow-lg w-full md:w-2/5 mt-4 lg:mt-6 hover:drop-shadow-xl  cursor-pointer">
